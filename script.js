...
function loaderanimation() {
  ...
  t1.from("#counter", {
    opacity: 0,
    onStart: function () {
      var counter = document.querySelector("#counter-left");
      var grow = 0;
  ...
  t1.from(
    "#hero1, #page2,#page3,#page4,#page5,#footer",
    {
      opacity: 0,
    },
    "-=1.2"
...
function sheryAnimation() {
  Shery.imageEffect(".img-div", {
    ...
    config: {
      ...
      aspect: { value: 0.8518668781843108 },
  ...
  Shery.makeMagnet(".box h5" /* Element to target.*/, {
